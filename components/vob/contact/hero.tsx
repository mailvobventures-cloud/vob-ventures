...
export default function ContactHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 py-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed text-pretty">
            Ready to start your business journey? We're here to help. Reach out for a free consultation.
          </p>
        </motion.div>
      </div>
    </section>
